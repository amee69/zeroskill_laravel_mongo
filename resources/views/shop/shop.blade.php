...
<x-guest-layout>
    <x-shop-layout>
        <div class="relative min-h-screen flex flex-col justify-between">
            <div class="relative z-10 flex flex-col items-center">
                <!-- Header Section -->
                <div class="flex justify-start w-full max-w-screen-2xl px-2 py-2">
                    <h1 id="start" class="font-bold text-3xl sm:text-4xl md:text-5xl text-white tracking-wider">
                        {{ $categoryModel->category_name ?? 'All Products' }}
                    </h1>
                </div>
                ...
                <!-- Desktop Product Grid -->
                <div class="hidden sm:grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 max-w-screen-2xl mt-8 mx-auto px-4">
                    @forelse ($products as $product)
                        <div class="shadow-lg rounded-xl overflow-hidden border border-gray-700 transition-transform transform hover:scale-105 mx-auto w-full max-w-[300px] flex flex-col justify-between">
            ...
            <!-- Pagination -->
            <div class="pagination mt-6 px-4">
                {{ $products->links() }}
            </div>
        </div>
    </x-shop-layout>
